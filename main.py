...
main = Tk()
main.title('DataFlair Event Management System')
...
Label(main, text="EVENT MANAGEMENT SYSTEM", font=headlabelfont, bg='GREY').pack(side=TOP, fill=X)
...
Label(left_frame, text="Event", font=labelfont, bg=lf_bg).place(relx=0.3, rely=0.44)
...
OptionMenu(left_frame, gender_strvar,'EVENT 1:ACAPELLA', "EVENT 2:STREET DANCE","EVENT 3:BATTLE OF BANDS","EVENT 4:MEGA").place(x=45, rely=0.49, relwidth=0.5)
...
Label(right_frame, text='Event Participants Record', font=headlabelfont, bg='black', fg='LightCyan').pack(side=TOP, fill=X)
...
tree.heading('Gender', text='Event', anchor=CENTER)
tree.heading('Date of Birth', text='DOB', anchor=CENTER)
tree.heading('Stream', text='Gender', anchor=CENTER)
